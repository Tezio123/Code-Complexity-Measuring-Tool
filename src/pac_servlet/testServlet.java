...
public class testServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(type.equals("size")) {
			...
			RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/Variable.jsp");
			dispatcher.forward(request, response);
			...
			RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/Method.jsp");
			dispatcher.forward(request, response);
			...
			RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/FinalResult.jsp");
			dispatcher.forward(request, response);
		}
