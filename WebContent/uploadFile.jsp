...
<div id="what-the-hell-is-this">
    <div class="page-title">
      <h1><b>Code Complexity Measuring Tool</b></h1>
        ...
        <br>
          ...
          <div align=center  class="form-group mt-3" >
           <p>COPY & PASTE YOUR CODE::</p>
            <textarea rows="6" cols="90" name="code" required></textarea>
          </div>
          <hr>
          ...
          <hr>
         			...
         			<div class="hideDiv" style="margin: auto;width:600px" id="sizeFactor" style="margin: auto;width:600px">
		  			<br>
		  				<h5 align="center"><b>Weight To Size</b></h5>
		  				<center>
		  				<table id="customers">
		  			...
		  			<br>
		  				<h5 align="center"><b>Weight To Variable</b></h5>
		  				<center>
		  				<table id="customers">
  							<thead class="thead-light">
			  					<tr>
		  			...
		  			<br>
		  				<h5 align="center"><b>Weight To Method</b></h5>
		  				<center>
		  				<table id="customers">
  							<thead class="thead-light">
			  					<tr>
		  			...
		  			<br>
		  				<h5 align="center"><b>Weight To Control Structure</b></h5>
		  				<center>
		  				<table id="customers">
  							<thead class="thead-light">
			  					<tr>
		  			...
		  			<br>
		  				<h5 align="center"><b>Weight To Inheritance</b></h5>
		  				<center>
		  				<table id="customers">
  							<thead class="thead-light">
			  					<tr>
		  			...
		  			<br>
		  				<h5 align="center"><b>Weight To Coupling</b></h5>
		  				<center>
		  				<table id="customers">
  							<thead class="thead-light">
			  					<tr>
          ...
          <br>
          <button type="submit" class="btn btn-primary" value="Save" >Run & Save</button>
